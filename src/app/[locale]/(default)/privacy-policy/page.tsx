  ...
  return (
    <>
      ...
      <div className="container mx-auto mt-20">
        ...
        <p>
          At andycao personal website, accessible from https://andycao.me, one
          of our main priorities is the privacy of our visitors. This Privacy
          Policy document contains types of information that is collected and
          recorded by andycao personal website and how we use it.
        </p>
        <p>
        ...
        <p>
          ...
          shared and/or collect in andycao personal website. This policy is not
        ...
        <p>
          andycao personal website follows a standard procedure of using log
        ...
        <p>
          Like any other website, andycao personal website uses
        ...
        <p>
          ...
          advertising partners of andycao personal website.
        </p>

        <p>
          Third-party ad servers or ad networks uses technologies like cookies,
          JavaScript, or Web Beacons that are used in their respective
          advertisements and links that appear on andycao personal website,
        ...
        <p>
          Note that andycao personal website has no access to or control over
          these cookies that are used by third-party advertisers.
        </p>
        <Typography variant="h2">Third Party Privacy Policies</Typography>
        <p>
          andycao personal website&apos;s Privacy Policy does not apply to other
        ...
        <p>
          andycao personal website does not knowingly collect any Personal
