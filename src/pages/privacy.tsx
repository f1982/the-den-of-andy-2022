...
const PrivacyPolicy = () => (
  <>
    ...
    <div className="container mx-auto mt-20">
      ...
      <p>
        At andycao personal website, accessible from https://andycao.me, one of our main priorities
        is the privacy of our visitors. This Privacy Policy document contains types of information
        that is collected and recorded by andycao personal website and how we use it.
      </p>
      <p>
      ...
      <p>
        ...
        website with regards to the information that they shared and/or collect in andycao personal
      ...
      <p>
        andycao personal website follows a standard procedure of using log files. These files log
      ...
      <p>
        Like any other website, andycao personal website uses &apos;cookies&apos;. These cookies are
        used to store information including visitors&apos; preferences, and the pages on the website
      ...
      <p>
        ...
        andycao personal website.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web
        Beacons that are used in their respective advertisements and links that appear on andycao
        personal website, which are sent directly to users&apos; browser. They automatically receive
      ...
      <p>
        Note that andycao personal website has no access to or control over these cookies that are
        used by third-party advertisers.
      </p>
      <Typography variant="h2">Third Party Privacy Policies</Typography>
      <p>
        andycao personal website&apos;s Privacy Policy does not apply to other advertisers or
      ...
      <p>
        andycao personal website does not knowingly collect any Personal Identifiable Information
