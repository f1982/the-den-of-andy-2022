const en = {
  translation: {
    ...
    siteTitle:
      "Andy's personal website is used for recording all his work and thinking.",
    siteDescription:
      "Andy's personal website is used for recording all his work and thinking.",
    siteKeywords:
      'AndyCao, Frontend developer, coding, website development, mobile app development',
    welcome: {
      pageTitle: 'Welcome',
    ...
    home: {
      ...
      p1: {
        ...
        p1: 'My name is Andy Cao and I come from China 🇨🇳. I am a Software Developer 👨‍💻 who focuses on website and mobile 📱 application development.',
        p2: 'I consider indie game 🕹 development as a leisure time hobby. I know some design 🎨. I am trying to be a life-long learner 🧠, an excellent drone 🛸 pilot as well as a good father 💁🏻‍♂️'
      },
      p2: {
        title: 'Projects',
    ...
    project: {
      pageTitle: 'Projects',
      headline: 'Projects',
      intro: 'There are some projects I have participated in.',
      title: 'Projects',
      description:
        'This is part of the project I participated in, and there are some projects that I have not organized and listed.'
    },
    hobbies: {
    ...
    about: {
      pageTitle: 'About me',
      headline: 'About',
      description: 'Here are something about me',
      whoIsAndyTitle: "Who's Andy",
      whoIsAndyDescription:
      ...
      familyTitle: 'Family',
      familyDescription:
        'I was very lucky to have met my wife Fang very early. She helped me immensely in my life and my spirit. We have a $AGE_OF_ZOE$ year old daughter, her name is Zoe and she is healthy and lively. Our family currently lives in Auckland.'
    },
    contact: {
      pageTitle: 'Contact',
